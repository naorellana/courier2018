...
<jsp:include page="../header.jsp" />
        <div class="container">
            <div class="row  col 12 center-align">
                <h1>Destinatarios</h1>
                <p>
                    <a href="<c:url value="newDestinatario" />" class="btn-floating waves-effect waves-light"><i class="material-icons green">add</i></a>
                </p>
                    ...
                    <tbody>
                        <c:forEach items="${datos}" var="dato">
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="editDestinatario?id=${dato.ID_DESTINATARIO}" />">
                                    ...
                                    <a href="<c:url value="deleteDestinatario?id=${dato.ID_DESTINATARIO}" />">
