...
<jsp:include page="../header.jsp" />
        <div class="container">
            <div class="row  col 12 center-align">
                <h1>País</h1>
                <p>
                    <a href="<c:url value="newPais" />" class="btn-floating waves-effect waves-light"><i class="material-icons green">add</i></a>
                </p>
                    ...
                    <tbody>
                        <c:forEach items="${datos}" var="dato">
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="editPais?id=${dato.ID_PAIS}" />">
                                        ...
                                        <a href="<c:url value="deletePais?id=${dato.ID_PAIS}" />">
