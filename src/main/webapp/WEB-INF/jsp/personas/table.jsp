...
<jsp:include page="../header.jsp" />
        <div class="container">
            <div class="row  col 12 center-align">
                <h1>Persona</h1>
                <p>
                    <a href="<c:url value="newPersona" />" class="btn-floating waves-effect waves-light"><i class="material-icons green">add</i></a>
                </p>
                <table class="highlight bordered table-responsive centered">
                    ...
                    <tbody>
                        <c:forEach items="${datos}" var="dato">
                            <tr>
                                <td><c:out value="${dato.DPI}" /></td>
                                <td><c:out value="${dato.NOMBRES}" /></td>
                                <td><c:out value="${dato.APELLIDOS}" /></td>
                                <td>
                                    <a href="<c:url value="editPersona?id=${dato.DPI}" />">
                                        ...
                                        <a href="<c:url value="deletePersona?id=${dato.DPI}" />">
